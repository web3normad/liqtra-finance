...
// backend/agent/src/config/constants.ts
// UPDATE the CONTRACTS section for Base Sepolia
...
export const CONFIG = {
  ...
  // Contracts - ALL CHECKSUMMED
  CONTRACTS: IS_TESTNET ? {
    // ✅ BASE SEPOLIA TESTNET - CORRECT ADDRESSES
    ...
    COMPOUND_COMET: '0xf25212e676d1f7f89cd72ffee66158f541246445', // cUSDCv3
    
    // Moonwell (not deployed on Base Sepolia testnet)
    MOONWELL: '0x0000000000000000000000000000000000000000', // Not available on testnet
  } : {
    // BASE MAINNET
    USDC: '0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913',
    AAVE_POOL: '0xA238Dd80C259a72e81d7e4664a9801593F98d1c5',
  ...
  PROTOCOLS: IS_TESTNET ? [
    ...
    // Moonwell not available on testnet, so only 2 protocols for testing
  ] : [
    {
      name: 'Aave',
      address: '0xA238Dd80C259a72e81d7e4664a9801593F98d1c5',
